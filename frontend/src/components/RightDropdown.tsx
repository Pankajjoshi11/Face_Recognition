import {
  ...
  const RightDropdown: React.FC<RightDropdownProps> = ({ onViewAttendance }) => {
    return (
        ...
        <div className="absolute top-0 m-2 p-2 right-0">
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-customBlue text-white mr-4">
              <DropdownMenuItem onClick={onViewAttendance}>
                Attendance History
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuSub>
                <DropdownMenuSubTrigger className="hover:text-black active:text-black focus:text-black">
                  Help
                </DropdownMenuSubTrigger>
